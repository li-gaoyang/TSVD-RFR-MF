...
if __name__ == '__main__':
    area="Sulige"
    neighbour =40 # 搜索最近邻域点个数
    samplepoints,xyz_points=RFRHelper.readsamplepoints('S14_8_train.txt',1,1,1)#读取样本数据
    save_txt_path="RFR_Interpolation_result"+str(neighbour)+"_"+area+".txt"
    save_vtk_path="RFR_Interpolation_result"+str(neighbour)+"_"+area+".vtk"
