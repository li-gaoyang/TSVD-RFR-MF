...
if __name__ == '__main__':
    ...
    samplepoints,xyz_points=RFRHelper.readsamplepoints('xyzv231.txt',5,5,1)#读取样本数据
    save_txt_path="RFR_Interpolation_result_231.txt"
    save_vtk_path="RFR_Interpolation_result_231.vtk"
    save_txt_path_unblur="RFR_Interpolation_result_231_unblur.txt"
    save_txt_path_blur="RFR_Interpolation_result_231.txt"
    if  comm_rank==0:
        start2 =time.clock()
