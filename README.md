...
## Data
We have two datasets: "S14_ 8_ train.txt" and "G3_ train_ 22.txt".
"G3_test_3.txt" and "S14_3_test.txt" are the test set to verify the interpolation accuracy. The distribution of datasets is shown in the figure.
![image](points.png)
In the dataset, each row represents each point. In each row, the first three numbers represent the coordinates of the point, and the fourth number represents the attribute value of the point.
